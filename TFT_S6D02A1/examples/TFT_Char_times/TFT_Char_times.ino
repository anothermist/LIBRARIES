...
void loop() {
  ...
  for (int i = 0; i < 1000; i++) {
    tft.drawNumber(i, 40, 40, 1);
  }

  drawTime = millis() - drawTime;

  tft.setTextColor(TFT_RED, TFT_BLACK);
  tft.drawFloat(drawTime / 2890.0, 3, 40, 90, 2);
  if (drawTime < 200) tft.drawString("Font 1 not loaded!", 40, 110, 2);
  ...
  tft.setTextColor(TFT_RED, TFT_BLACK);
  tft.drawFloat(drawTime / 2890.0, 3, 40, 90, 2);
  if (drawTime < 200) tft.drawString("Font 2 not loaded!", 40, 110, 2);
  ...
  tft.setTextColor(TFT_RED, TFT_BLACK);
  tft.drawFloat(drawTime / 2890.0, 3, 40, 90, 2);
  if (drawTime < 200) tft.drawString("Font 4 not loaded!", 40, 110, 2);
  ...
  tft.setTextColor(TFT_RED, TFT_BLACK);
  tft.drawFloat(drawTime / 2890.0, 3, 40, 90, 2);
  if (drawTime < 200) tft.drawString("Font 6 not loaded!", 40, 110, 2);
  ...
  tft.setTextColor(TFT_RED, TFT_BLACK);
  tft.drawFloat(drawTime / 2890.0, 3, 40, 90, 2);
  if (drawTime < 200) tft.drawString("Font 7 not loaded!", 40, 110, 2);
  ...
  for (int i = 0; i < 100; i++) {
    tft.drawNumber(i, 25, 10, 8);
  }

  drawTime = millis() - drawTime;

  tft.setTextColor(TFT_RED, TFT_BLACK);
  tft.drawFloat(drawTime / 190.0, 3, 40, 90, 2);
  if (drawTime < 200) tft.drawString("Font 8 not loaded!", 40, 110, 2);
