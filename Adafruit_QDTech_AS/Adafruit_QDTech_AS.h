...
#ifndef Adafruit_QDTech_AS_h
#define Adafruit_QDTech_AS_h
...
#define QDTech_ORANGE  0xFBE0

class Adafruit_QDTech_AS : public Adafruit_GFX_AS {

 public:

  Adafruit_QDTech_AS(uint8_t CS, uint8_t RS, uint8_t SID, uint8_t SCLK, uint8_t RST);
  Adafruit_QDTech_AS(uint8_t CS, uint8_t RS, uint8_t RST);
