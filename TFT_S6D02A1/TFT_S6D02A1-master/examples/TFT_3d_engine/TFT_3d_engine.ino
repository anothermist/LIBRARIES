// =============================================================================
//
// Adapted by Bodmer for the TFT_S6D02A1 library
//
// Arduino - Tiny 3D Engine
// ------------------------
// by Themistokle "mrt-prodz" Benetatos
//
// This is a tiny 3D engine made for the ATMEGA328 and a 1.8" TFT screen (TFT).
//
...
#define COLOR0 TFT_BLACK
#define COLOR1 TFT_WHITE
#define COLOR2 TFT_GREEN
#define COLOR3 TFT_YELLOW
#define COLOR4 TFT_BLUE
#define COLOR5 TFT_CYAN
#define COLOR6 TFT_RED
#define COLOR7 TFT_MAGENTA
  ...
  if (memcmp(old_nodes, proj_nodes, sizeof(proj_nodes))) {
    ...
    switch(draw_type) {
      ...
      case 1: if (TRICOUNT > 32) clear_dirty(old_nodes);
              ...
              draw_wireframe(proj_nodes, COLOR2);
              break;
