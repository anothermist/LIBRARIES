...
void Adafruit_ST7735_AS::commandList(const uint8_t *addr) {
...
void Adafruit_ST7735_AS::commonInit(const uint8_t *cmdList) {
...
void Adafruit_ST7735_AS::initB(void) {
  commonInit(Bcmd);
}


// Initialization for ST7735R screens (green or red tabs)
void Adafruit_ST7735_AS::initR(uint8_t options) {
  commonInit(Rcmd1);
...
void Adafruit_ST7735_AS::setAddrWindow(uint8_t x0, uint8_t y0, uint8_t x1,
 uint8_t y1) {
...
void Adafruit_ST7735_AS::drawPixel(int16_t x, int16_t y, uint16_t color) {
...
void Adafruit_ST7735_AS::drawFastHLine(int16_t x, int16_t y, int16_t w,
  uint16_t color) {
...
void Adafruit_ST7735_AS::fillScreen(uint16_t color) {
...
// fill a rectangle
void Adafruit_ST7735_AS::fillRect(int16_t x, int16_t y, int16_t w, int16_t h,
  uint16_t color) {
...
uint16_t Adafruit_ST7735_AS::Color565(uint8_t r, uint8_t g, uint8_t b) {
...
void Adafruit_ST7735_AS::setRotation(uint8_t m) {
