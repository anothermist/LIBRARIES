...
# ACDS 15.1 185 linux 2016.03.29.13:50:18
...
# # End of template
# ----------------------------------------
# If xlr8_float_add1 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 15.1 185 linux 2016.03.29.13:50:19
# ----------------------------------------
# initialize variables
TOP_LEVEL_NAME="xlr8_float_add1"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/cad/tools/altera/15.1-lite/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/xlr8_float_add1.vo"
fi
