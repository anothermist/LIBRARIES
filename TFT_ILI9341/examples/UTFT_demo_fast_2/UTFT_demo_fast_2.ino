...
TFT_ILI9341 myGLCD = TFT_ILI9341(cs, dc, rst);       // Invoke custom library
//Adafruit_TFT_AS myGLCD = Adafruit_TFT_AS(cs, dc ,mosi ,sclk , rst ,12);       // Invoke custom library
...
// Clear the screen and draw the frame
  ...
  myGLCD.drawCentreString("* TFT_AS Color TFT Display Library *", 160, 4, 1);
  myGLCD.setTextColor(TFT_YELLOW,TFT_GREY);
  myGLCD.drawCentreString("Adapted by Bodmer 13/2/15", 160, 228,1);
