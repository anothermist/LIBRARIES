...
void loop() {
  ...
  if (targetTime < millis()) {
    ...
    tft.setTextColor(R61581_BLACK, R61581_BLACK); // Note these fonts do not plot the background colour
    tft.setCursor (68, 5);
    tft.print("Original ADAfruit font!");
    
    // The new larger fonts do not use the .setCursor call, coords are embedded
    tft.setTextColor(R61581_BLACK); // Do not plot the background colour
